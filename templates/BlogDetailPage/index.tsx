                            ...
                            <div className="mb-12 flex flex-wrap gap-3">
                                ...
                                {article.githubUrl && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white/10 text-white rounded-full text-body font-medium hover:bg-gray-700 dark:hover:bg-white/20 transition-colors"
                                    >
